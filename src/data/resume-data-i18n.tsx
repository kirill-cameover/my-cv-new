...
export const RESUME_DATA_I18N: Record<Locale, ResumeData> = {
  ru: {
    ...
    about: "ПРОДАЖИ · ПАРТНЁРСТВА · YOUTUBE PRODUCTION",
    role: "ПРОДАЖИ · ПАРТНЁРСТВА · YOUTUBE PRODUCTION",
    headline: "Продюсер YouTube подкастов",
    highlights: [
      "6+ лет опыта",
      "Выручка 3M$ в год",
      "+500 встреч",
    ...
    summary: (
      <>
        <p>
          <b>РОП и BizDev с опытом продюсирования YouTube-медиа/подкастов. Закрываю sponsorship-сделки, строю долгосрочные партнёрства, запускаю шоу под рекламодателей. Формирую команды и продажи. Делаю YouTube проекты прибыльными.</b>
        </p>
        <p>
          Активный нетворкинг на отраслевых ивентах (Blockchain Life, Crypto Summit, etc.). Рабочие контакты с Tier-1 проектами и развитая сеть KOL и агентств.
        </p>
        <p>
